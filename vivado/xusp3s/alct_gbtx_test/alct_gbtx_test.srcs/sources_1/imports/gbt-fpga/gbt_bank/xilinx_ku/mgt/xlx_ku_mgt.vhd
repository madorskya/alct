...
architecture structural of mgt is
   ...
   --==============================--
       ...
       signal zero_1b :std_logic_vector(0 to 0) := "0";
...
--            ); 
          ...
          drpaddr_in     <= zero_1b & MGT_DEVSPEC_i.drp_addr(i);
          txdiffctrl_in  <= zero_1b & MGT_DEVSPEC_i.conf_diffCtrl(i);
          ...
          xlx_ku_mgt_std_i: xlx_ku_mgt_ip
             PORT MAP (          
                 ...
                 drpaddr_in                             => drpaddr_in, --MGT_DEVSPEC_i.drp_addr(i),
                 ...
                 gtyrxn_in(0)                           => MGT_DEVSPEC_i.rx_n(i),
                 gtyrxp_in(0)                           => MGT_DEVSPEC_i.rx_p(i),
                 gtytxn_out(0)                          => MGT_DEVSPEC_o.tx_n(i),
                 gtytxp_out(0)                          => MGT_DEVSPEC_o.tx_p(i),
                 ...
                 txdiffctrl_in                          => txdiffctrl_in, --MGT_DEVSPEC_i.conf_diffCtrl(i),
