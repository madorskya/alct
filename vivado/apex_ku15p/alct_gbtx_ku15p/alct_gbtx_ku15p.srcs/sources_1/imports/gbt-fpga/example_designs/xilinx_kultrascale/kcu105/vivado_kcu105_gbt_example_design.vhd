...
-- Maq     CPU_RESET                                      : in  std_logic;     
      ...
      -- System clock:
      ----------------
-- Maq     SYSCLK_P                                     : in  std_logic;
--      SYSCLK_N                                     : in  std_logic;   
            
      -- Fabric clock:
      ----------------     

-- Maq     USER_CLOCK_P                                   : in  std_logic;
...
-- Maq      SFP_TX_DISABLE                                 : out std_logic;    
      ...
      -- SMA output:
      --------------
-- Maq      USER_SMA_GPIO_P                                : out std_logic;    
...
architecture structural of kcu105_gbt_example_design is
   ...
   --================================ Signal Declarations ================================--          
    signal   CPU_RESET                                    : std_logic := '0'; -- Maq
    signal  SFP_TX_DISABLE                                 :  std_logic;    -- Maq
    signal  USER_SMA_GPIO_P                                :  std_logic;    -- Maq
    signal  USER_SMA_GPIO_N                                :  std_logic;    -- Maq
...
--      );
   ...
   smaMgtRefClkIbufdsGtxe2: ibufds_gte4 --3 Maq
      generic map(
        REFCLK_EN_TX_PATH           => '0',
    ...
    txPllBuf_inst: bufg_gt
     ...
     -- Maq using refclk for all system clocks
     fabricClk_from_userClockIbufgds <= mgtClkBuf_to_txPll;
     sysclk                          <= mgtClkBuf_to_txPll;
