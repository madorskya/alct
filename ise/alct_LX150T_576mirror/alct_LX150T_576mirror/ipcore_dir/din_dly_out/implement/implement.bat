...
xst -ifn xst.scr
move din_dly_out_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\din_dly_out_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc din_dly_out_exdes.ucf din_dly_out_exdes

echo 'Running map'
map -timing din_dly_out_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm din_dly_out_exdes -w routed.ncd routed.v
cd ..
