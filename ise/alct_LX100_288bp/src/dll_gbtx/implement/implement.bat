...
xst -ifn xst.scr
move dll_gbtx_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dll_gbtx_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dll_gbtx_exdes.ucf dll_gbtx_exdes

echo 'Running map'
map -timing -pr b dll_gbtx_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dll_gbtx_exdes -w routed.ncd routed.v
cd ..
